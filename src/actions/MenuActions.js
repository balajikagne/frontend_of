...
export const getAllitems=()=>async dispatch=>{
    ...
    try {
        const response=await axios.get('http://51.20.194.197:5002/api/items/getallitems')
...
export const getItemById=(item)=>async (dispatch)=>{
    ...
    console.log(item);
    try {
        const response=await axios.post('http://51.20.194.197:5002/api/items/getitembyid',item)
