...
export const getAllitems=()=>async dispatch=>{
    ...
    try {
        const response=await axios.get('1https://balajibackend-demo-1.onrender.com/api/items/getallitems')
...
export const addItems=(item)=>async (dispatch)=>{
    ...
    try {
        const response=await axios.post('1https://balajibackend-demo-1.onrender.com/api/items/additem',item)
...
export const getItemById=(item)=>async (dispatch)=>{
    ...
    console.log(item);
    try {
        const response=await axios.post('1https://balajibackend-demo-1.onrender.com/items/getitembyid',item)
...
export const deleteItem=(itemId)=>async (dispatch)=>{
    console.log({itemId})
    try {
        const response=await axios.post('1https://balajibackend-demo-1.onrender.com/api/items/deleteitem',{itemId})
...
export const filterItem=(searchkey,category)=>async dispatch=>{
    ...
    dispatch({type:'GET_ITEMS_REQ'})
    try{
        const res=await axios.get("1https://balajibackend-demo-1.onrender.com/api/items/getallitems")
