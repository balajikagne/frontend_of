...
export const placeOrder = (token, subtotal) => async (dispatch, getState) => {
  ...
  try {
    const res = await axios.post("https://testygo.xyz/api/orders/placeorder", {
      token,
      subtotal,
      currentUser,
      cartItems,
...
try{
  const response=await axios.post("https://testygo.xyz/api/orders/getuserorder",{
...
export const getALLOrders = () => async (dispatch,getState) => {
    ...
    try {
      const res = await axios.get("https://testygo.xyz/api/orders/getallorders");
  ...
  export const deliveredOrders = (orderid) => async (dispatch,getState) => {
    ...
    try {
      const res = await axios.post("https://testygo.xyz/api/orders/deliverorder",{orderid});
