...
export const placeOrder = (token, subtotal,checker) => async (dispatch, getState) => {
  ...
  try {
    const res = await axios.post("https://tiny-lime-squid-tie.cyclic.app/api/orders/placeorder", {
      token,
      subtotal,
      currentUser,
      cartItems,
...
try{
  const response=await axios.post("https://tiny-lime-squid-tie.cyclic.app/api/orders/getuserorder",{
...
export const getALLOrders = () => async (dispatch,getState) => {
    ...
    try {
      const res = await axios.get("https://tiny-lime-squid-tie.cyclic.app/api/orders/getallorders");
  ...
  export const deliveredOrders = (orderid) => async (dispatch,getState) => {
    ...
    try {
      const res = await axios.post("https://tiny-lime-squid-tie.cyclic.app/api/orders/deliverorder",{orderid});
      const orders=await  axios.get("https://tiny-lime-squid-tie.cyclic.app/api/items/getallitems")
  ...
  export const StockIn = (itemId) => async (dispatch,getState) => {
    ...
    try {
      const res = await axios.post("https://tiny-lime-squid-tie.cyclic.app/api/items/itemlistin",{itemId});
      const orders=await  axios.get("https://tiny-lime-squid-tie.cyclic.app/api/items/getallitems")
  ...
  export const StockOut = (itemId) => async (dispatch,getState) => {
    dispatch({type:'GET_ITEMS_REQ'});
    try {
      const res = await axios.post("https://tiny-lime-squid-tie.cyclic.app/api/items/itemlistout",{itemId});
      const orders=await  axios.get("https://tiny-lime-squid-tie.cyclic.app/api/items/getallitems")
      dispatch({type:'GET_ITEMS_SUCCESS',payload:orders.data});
      // window.location.href="/admin/itemlist"
    } catch (error) {
