...
export default function Filters() {
  ...
  <div style={{width:'100%',marginBottom:'20px'}}>
        ...
        <div style={{height:'100px',width:'100px',cursor:'pointer',textAlign:'center'}} onClick={(e)=>{scall('all')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://images.pexels.com/photos/958545/pexels-photo-958545.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'id="sitem"></img></a></div>
          ...
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('nonveg sandwich')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1300550738/photo/chicken-sandwiches.jpg?s=612x612&w=0&k=20&c=dHQShf7a7y9nHWJWpRqu3AIuwIAdUg_UWYUts89NYhM=' id="sitem"></img><h2>N-Sandwich</h2></a></div>
