...
export default function Filters() {
  ...
  return (
    ...
    <div style={{marginBottom:'20px'}} className="p-4 bg-light mt-4 ">
      <div style={{display:'flex',marginBottom:'20px'}}>
        ...
        if (e.key === "Enter" ||e.key ==='Search'||e.key==='Forword')
        dispatch(filterItem(searchkey.toLowerCase()));
        }}/>
 ...
 <div style={{width:'100%',marginBottom:'40px'}}>
        ...
        <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('veg noodles')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1292637257/photo/veg-hakka-noodles-a-popular-oriental-dish-made-with-noodles-and-vegetables-served-over-a.jpg?s=612x612&w=0&k=20&c=ckgGtleqsGxEMEW0ZlOR9eM8ii_R3A1apAMo8xa2Cr4=' id="sitem"></img><h2 className='tname'>Veg Noodles</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('nonveg noodles')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1459152165/photo/spicy-chilli-mao-xiang-big-fish-head-with-fish-pork-bean-pork-with-potato-flour-served-dish.jpg?s=612x612&w=0&k=20&c=hGU6PE0Cht0goYeYYy5zxOkfcfvJOrzlrhPFtTO_iAM=' id="sitem"></img><h2 className='tname'>N-Noodles</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('veg roll')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1400256468/photo/mix-vegetable-kathi-roll.jpg?s=612x612&w=0&k=20&c=ZH9fbHJaKkYjzFvl1hTnsl5wdx35pFnBLTKBonBZLw0=' id="sitem"></img><h2 className='tname'>Veg Roll</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('nonveg roll')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1438449132/photo/egg-cheese-chicken-burger-shawarma-wrap-with-salad-dip-and-sauce-isolated-wooden-board-side.jpg?s=612x612&w=0&k=20&c=o34qlfaytv5yfsxdmaWNdU6u524cGl3NXn-X5fjAFdY=' id="sitem"></img><h2 className='tname'>N-Veg Roll</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('nuggets')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1154557976/photo/chicken-nuggets-with-ketchup-popular-american-fast-food-snack-quick-bites-appetizer.jpg?s=612x612&w=0&k=20&c=OElI-vGekjFgmynegkwG-rn3rfrDUEy5IssqnshL0PY=' id="sitem"></img><h2 className='tname'>Nuggets</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('milkshake')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/174956542/photo/non-alcoholic-strawberry-milkshake-cocktail-on-the-classic-black-bar-table.jpg?s=612x612&w=0&k=20&c=WGfVYxkzV3hxsA7C9GHprft39KU5Vn_LYN80rlkCf9I=' id="sitem"></img><h2 className='tname'>Milkshaker</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('maggie')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1292638282/photo/maggie-noodles-instant-noodles-served-in-a-bowl-over-a-rustic-wooden-background-selective.jpg?s=612x612&w=0&k=20&c=7HjVH0Y2HuycpQtjezRdLYKF6BkaEaE_wVO0IqC2uKo=' id="sitem"></img><h2 className='tname'>Maggie</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('coffee')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/867813076/photo/cold-coffee-shake.jpg?s=612x612&w=0&k=20&c=lkdYRGQWogU8ezhdlhAX--z6VW1yEkxeugFJ6q5v-gE=' id="sitem"></img><h2 className='tname'>Coffee</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('fries')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://images.unsplash.com/photo-1585109649139-366815a0d713?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80' id="sitem"></img><h2 className='tname'>Fries</h2></a></div>
