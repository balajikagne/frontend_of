...
export default function Filters() {
 ...
 <div style={{width:'100%',marginBottom:'20px'}}>
        ...
        <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('veg noodles')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1292637257/photo/veg-hakka-noodles-a-popular-oriental-dish-made-with-noodles-and-vegetables-served-over-a.jpg?s=612x612&w=0&k=20&c=ckgGtleqsGxEMEW0ZlOR9eM8ii_R3A1apAMo8xa2Cr4=' id="sitem"></img><h2>Veg Noodles</h2 className='tname'></a></div>
