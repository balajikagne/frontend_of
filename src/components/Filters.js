...
export default function Filters() {
  ...
  <div style={{width:'100%',marginBottom:'20px'}}>
        ...
        <div style={{height:'100px',width:'100px',cursor:'pointer',textAlign:'center'}} onClick={(e)=>{scall('all')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://images.pexels.com/photos/958545/pexels-photo-958545.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'id="sitem"></img><h2>All Menus</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('veg burger')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://cdn.pixabay.com/photo/2016/03/05/19/02/hamburger-1238246_1280.jpg' id="sitem"></img><h2>Veg Burger</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('nonveg burger')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://images.pexels.com/photos/918581/pexels-photo-918581.jpeg' id="sitem"></img><h2>N-Veg Burger</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('veg pizza')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1341905556/photo/chinese-food-veg-pizza.jpg?s=612x612&w=0&k=20&c=v8fOYCmKapktf_tzg2wKx1I-sLD8ZyUhnMo1N_AsVEQ=' id="sitem"></img><h2>Veg Pizza</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('nonveg pizza')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/186295807/photo/chicken-tikka-pizza.jpg?s=612x612&w=0&k=20&c=gnF-DKlj1JCCAhzQ4fB8WEyJ_cUlgl1i-ZNsIuvZ54U=' id="sitem"></img><h2>N-Veg Pizza</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('beverages')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='logo1.png' id="sitem"></img><h2>Beverages</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('cake')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1319549646/photo/happy-birthday-chocolate-cake-with-cherry.jpg?s=612x612&w=0&k=20&c=U6PwDMCH-622xo31ZSXZQJ0ZSJOzQpBb2J45JbiV11I=' id="sitem"></img><h2>Cake</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('veg rice')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1292617507/photo/tasty-veg-schezwan-fried-rice-served-in-bowl-over-a-rustic-wooden-background-indian-cuisine.jpg?s=612x612&w=0&k=20&c=MlfiFWbcPDUj2wnjtxoHBxSUrRrKb9c1OR8rS9H4goc=' id="sitem"></img><h2>Veg Rice</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('nonveg rice')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/644021564/photo/jollof-rice-with-chicken-and-fried-plantain-west-african-cuisine.jpg?s=612x612&w=0&k=20&c=T9QnCp1TPNyxcmD0Qk6FtCjCIs9a6Jpz6EEFCgqouSo=' id="sitem"></img><h2>N-Veg Rice</h2></a></div>
          <div style={{height:'100px',width:'100px',cursor:'pointer'}} onClick={(e)=>{scall('veg sandwich')}}><a style={{textDecoration:'none',color:'black'}} href="#itemloc"><img src='https://media.istockphoto.com/id/1367549564/photo/sandwich-isolated-on-white-background-gourmet-toast-or-sandwich-with-veg-petty-lettuce-tomato.jpg?s=612x612&w=0&k=20&c=1sbBA8c7yMizs-KKJt0OTyy7sSqFk2pYxZdmx-GnkeU=' id="sitem"></img><h2>V-Sandwich</h2></a></div>
